            ...
            <form action="{{ route('tickets.update', ['ticket' => $ticket->id]) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" id="content" class="form-control" rows="5"
                        required>{{ old('content', $ticket->content) }}</textarea>
                    @error('content')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="ticket_category_id" id="ticket_category_id" class="form-select" required>
                        ...
                        <option value="{{ $category->id }}" {{ old('ticket_category_id', $ticket->ticket_category_id) ==
                ...
                <div class="mb-3">
                    ...
                    <select name="ticket_priority_id" id="ticket_priority_id" class="form-select" required>
                        ...
                        <option value="{{ $priority->id }}" {{ old('ticket_priority_id', $ticket->ticket_priority_id) ==
